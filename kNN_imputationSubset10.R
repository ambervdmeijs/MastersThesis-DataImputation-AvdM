...
S10kNN2.1_correct <- S10kNN2.2_correct <- S10kNN2.3_correct <- S10kNN5.1_correct <- S10kNN5.2_correct <- S10kNN5.3_correct <- S10kNN10.1_correct <- S10kNN10.2_correct <- S10kNN10.3_correct <- 0
S10kNN2.1_total <- S10kNN2.2_total <- S10kNN2.3_total <- S10kNN5.1_total <- S10kNN5.2_total <- S10kNN5.3_total <- S10kNN10.1_total <- S10kNN10.2_total <- S10kNN10.3_total <- 0
...
S10_kNNMCAR2.1 <- as.matrix(sub10_MCAR2.1)
names(S10_kNNMCAR2.1) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 2.1 processing time...")
S10_kNN2.1 <- knn.impute(S10_kNNMCAR2.1, k = 10) 
toc(log = TRUE)
S10df_kNN2.1 <- as.data.frame(S10_kNN2.1)
save(S10df_kNN2.1, file = "S10_kNN21.Rdata")
S10kNN2.1_correct <- S10kNN2.1_correct + sum(sub_ipums10 == S10df_kNN2.1)
S10kNN2.1_total <- S10kNN2.1_total + sum(!is.na(S10df_kNN2.1))

#2.2 data set
sub10_MCAR2.2 <- get(load(file = "sub10_mcar22.Rdata"))
S10_kNNMCAR2.2 <- as.matrix(sub10_MCAR2.2)
names(S10_kNNMCAR2.2) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 2.2 processing time...")
S10_kNN2.2 <- knn.impute(S10_kNNMCAR2.2, k = 10) 
toc(log = TRUE)
S10df_kNN2.2 <- as.data.frame(S10_kNN2.2)
save(S10df_kNN2.2, file = "S10_kNN22.Rdata")
S10kNN2.2_correct <- S10kNN2.2_correct + sum(sub_ipums10 == S10df_kNN2.2)
S10kNN2.2_total <- S10kNN2.2_total + sum(!is.na(S10df_kNN2.2))

# 2.3 data set
sub10_MCAR2.3 <- get(load(file = "sub10_mcar23.Rdata"))
S10_kNNMCAR2.3 <- as.matrix(sub10_MCAR2.3)
names(S10_kNNMCAR2.3) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 2.3 processing time...")
S10_kNN2.3 <- knn.impute(S10_kNNMCAR2.3, k = 10) 
toc(log = TRUE)
S10df_kNN2.3 <- as.data.frame(S10_kNN2.3)
save(S10df_kNN2.3, file = "S10_kNN23.Rdata")
S10kNN2.3_correct <- S10kNN2.3_correct + sum(sub_ipums10 == S10df_kNN2.3)
S10kNN2.3_total <- S10kNN2.3_total + sum(!is.na(S10df_kNN2.3))
...
S10_kNNMCAR5.1 <- as.matrix(sub10_MCAR5.1)
names(S10_kNNMCAR5.1) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 5.1 processing time...")
S10_kNN5.1 <- knn.impute(S10_kNNMCAR5.1, k = 10) 
toc(log = TRUE)
S10df_kNN5.1 <- as.data.frame(S10_kNN5.1)
save(S10df_kNN5.1, file = "S10_kNN51.Rdata")
S10kNN5.1_correct <- S10kNN5.1_correct + sum(sub_ipums10 == S10df_kNN5.1)
S10kNN5.1_total <- S10kNN5.1_total + sum(!is.na(S10df_kNN5.1))

# 5.2 data set
sub10_MCAR5.2 <- get(load(file = "sub10_mcar52.Rdata"))
S10_kNNMCAR5.2 <- as.matrix(sub10_MCAR5.2)
names(S10_kNNMCAR5.2) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 5.2 processing time...")
S10_kNN5.2 <- knn.impute(S10_kNNMCAR5.2, k = 10) 
toc(log = TRUE)
S10df_kNN5.2 <- as.data.frame(S10_kNN5.2)
save(S10df_kNN5.2, file = "S10_kNN52.Rdata")
S10kNN5.2_correct <- S10kNN5.2_correct + sum(sub_ipums10 == S10df_kNN5.2)
S10kNN5.2_total <- S10kNN5.2_total + sum(!is.na(S10df_kNN5.2))

# 5.3 data set
sub10_MCAR5.3 <- get(load(file = "sub10_mcar53.Rdata"))
S10_kNNMCAR5.3 <- as.matrix(sub10_MCAR5.3)
names(S10_kNNMCAR5.3) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 5.3 processing time...")
S10_kNN5.3 <- knn.impute(S10_kNNMCAR5.3, k = 10) 
toc(log = TRUE)
S10df_kNN5.3 <- as.data.frame(S10_kNN5.3)
save(S10df_kNN5.3, file = "S10_kNN53.Rdata")
S10kNN5.3_correct <- S10kNN5.3_correct + sum(sub_ipums10 == S10df_kNN5.3)
S10kNN5.3_total <- S10kNN5.3_total + sum(!is.na(S10df_kNN5.3))
...
S10_kNNMCAR10.1 <- as.matrix(sub10_MCAR10.1)
names(S10_kNNMCAR10.1) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 10.1 processing time...")
S10_kNN10.1 <- knn.impute(S10_kNNMCAR10.1, k = 10) 
toc(log = TRUE)
S10df_kNN10.1 <- as.data.frame(S10_kNN10.1)
save(S10df_kNN10.1, file = "S10_kNN101.Rdata")
S10kNN10.1_correct <- S10kNN10.1_correct + sum(sub_ipums10 == S10df_kNN10.1)
S10kNN10.1_total <- S10kNN10.1_total + sum(!is.na(S10df_kNN10.1))

#10.2 data set
sub10_MCAR10.2 <- get(load(file = "sub10_mcar102.Rdata"))
S10_kNNMCAR10.2 <- as.matrix(sub10_MCAR10.2)
names(S10_kNNMCAR10.2) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 10.2 processing time...")
S10_kNN10.2 <- knn.impute(S10_kNNMCAR10.2, k = 10) 
toc(log = TRUE)
S10df_kNN10.2 <- as.data.frame(S10_kNN10.2)
save(S10df_kNN10.2, file = "S10_kNN102.Rdata")
S10kNN10.2_correct <- S10kNN10.2_correct + sum(sub_ipums10 == S10df_kNN10.2)
S10kNN10.2_total <- S10kNN10.2_total + sum(!is.na(S10df_kNN10.2))

#10.3 data set
sub10_MCAR10.3 <- get(load(file = "sub10_mcar103.Rdata"))
S10_kNNMCAR10.3 <- as.matrix(sub10_MCAR10.3)
names(S10_kNNMCAR10.3) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
tic("kNN 10.3 processing time...")
S10_kNN10.3 <- knn.impute(S10_kNNMCAR10.3, k = 10) 
toc(log = TRUE)
S10df_kNN10.3 <- as.data.frame(S10_kNN10.3)
save(S10df_kNN10.3, file = "S10_kNN103.Rdata")
S10kNN10.3_correct <- S10kNN10.3_correct + sum(sub_ipums10 == S10df_kNN10.3)
S10kNN10.3_total <- S10kNN10.3_total + sum(!is.na(S10df_kNN10.3))
...
S10kNN2.1_accuracy <- S10kNN2.1_correct / S10kNN2.1_total
S10kNN2.2_accuracy <- S10kNN2.2_correct / S10kNN2.2_total
S10kNN2.3_accuracy <- S10kNN2.3_correct / S10kNN2.3_total

S10kNN5.1_accuracy <- S10kNN5.1_correct / S10kNN5.1_total
S10kNN5.2_accuracy <- S10kNN5.2_correct / S10kNN5.2_total
S10kNN5.3_accuracy <- S10kNN5.3_correct / S10kNN5.3_total

S10kNN10.1_accuracy <- S10kNN10.1_correct / S10kNN10.1_total
S10kNN10.2_accuracy <- S10kNN10.2_correct / S10kNN10.2_total
S10kNN10.3_accuracy <- S10kNN10.3_correct / S10kNN10.3_total
...
names(S10df_kNN2.1) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN2.2) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN2.3) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN5.1) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN5.2) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN5.3) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN10.1) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN10.2) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
names(S10df_kNN10.3) <- gsub(" ", "_", names(sub_ipums10), fixed=TRUE)
...
# Counting values
kNN2.1_Geslacht <- plyr::count(S10df_kNN2.1, 'Geslacht')
kNN2.1_Leeftijd <- plyr::count(S10df_kNN2.1, 'Leeftijd')
kNN2.1_HH_Pos <- plyr::count(S10df_kNN2.1, 'HH_Pos')
kNN2.1_HH_grootte <- plyr::count(S10df_kNN2.1, 'HH_grootte')
kNN2.1_Woonregio_vorig_jaar <- plyr::count(S10df_kNN2.1, 'Woonregio_vorig_jaar')
kNN2.1_Nationaliteit <- plyr::count(S10df_kNN2.1, 'Nationaliteit')
kNN2.1_Geboorteland <- plyr::count(S10df_kNN2.1, 'Geboorteland')
kNN2.1_Onderwijsniveau <- plyr::count(S10df_kNN2.1, 'Onderwijsniveau')
kNN2.1_Econ_status <- plyr::count(S10df_kNN2.1, 'Econ._status')
kNN2.1_Beroep <- plyr::count(S10df_kNN2.1, 'Beroep')
kNN2.1_SBI <- plyr::count(S10df_kNN2.1, 'SBI')
kNN2.1_Burg_Staat <- plyr::count(S10df_kNN2.1, 'Burg._Staat')

kNN2.2_Geslacht <- plyr::count(S10df_kNN2.2, 'Geslacht')
kNN2.2_Leeftijd <- plyr::count(S10df_kNN2.2, 'Leeftijd')
kNN2.2_HH_Pos <- plyr::count(S10df_kNN2.2, 'HH_Pos')
kNN2.2_HH_grootte <- plyr::count(S10df_kNN2.2, 'HH_grootte')
kNN2.2_Woonregio_vorig_jaar <- plyr::count(S10df_kNN2.2, 'Woonregio_vorig_jaar')
kNN2.2_Nationaliteit <- plyr::count(S10df_kNN2.2, 'Nationaliteit')
kNN2.2_Geboorteland <- plyr::count(S10df_kNN2.2, 'Geboorteland')
kNN2.2_Onderwijsniveau <- plyr::count(S10df_kNN2.2, 'Onderwijsniveau')
kNN2.2_Econ_status <- plyr::count(S10df_kNN2.2, 'Econ._status')
kNN2.2_Beroep <- plyr::count(S10df_kNN2.2, 'Beroep')
kNN2.2_SBI <- plyr::count(S10df_kNN2.2, 'SBI')
kNN2.2_Burg_Staat <- plyr::count(S10df_kNN2.2, 'Burg._Staat')

kNN2.3_Geslacht <- plyr::count(S10df_kNN2.3, 'Geslacht')
kNN2.3_Leeftijd <- plyr::count(S10df_kNN2.3, 'Leeftijd')
kNN2.3_HH_Pos <- plyr::count(S10df_kNN2.3, 'HH_Pos')
kNN2.3_HH_grootte <- plyr::count(S10df_kNN2.3, 'HH_grootte')
kNN2.3_Woonregio_vorig_jaar <- plyr::count(S10df_kNN2.3, 'Woonregio_vorig_jaar')
kNN2.3_Nationaliteit <- plyr::count(S10df_kNN2.3, 'Nationaliteit')
kNN2.3_Geboorteland <- plyr::count(S10df_kNN2.3, 'Geboorteland')
kNN2.3_Onderwijsniveau <- plyr::count(S10df_kNN2.3, 'Onderwijsniveau')
kNN2.3_Econ_status <- plyr::count(S10df_kNN2.3, 'Econ._status')
kNN2.3_Beroep <- plyr::count(S10df_kNN2.3, 'Beroep')
kNN2.3_SBI <- plyr::count(S10df_kNN2.3, 'SBI')
kNN2.3_Burg_Staat <- plyr::count(S10df_kNN2.3, 'Burg._Staat')

rm(S10df_kNN2.1, S10df_kNN2.2, S10df_kNN2.3)
...
# Counting values
kNN5.1_Geslacht <- plyr::count(S10df_kNN5.1, 'Geslacht')
kNN5.1_Leeftijd <- plyr::count(S10df_kNN5.1, 'Leeftijd')
kNN5.1_HH_Pos <- plyr::count(S10df_kNN5.1, 'HH_Pos')
kNN5.1_HH_grootte <- plyr::count(S10df_kNN5.1, 'HH_grootte')
kNN5.1_Woonregio_vorig_jaar <- plyr::count(S10df_kNN5.1, 'Woonregio_vorig_jaar')
kNN5.1_Nationaliteit <- plyr::count(S10df_kNN5.1, 'Nationaliteit')
kNN5.1_Geboorteland <- plyr::count(S10df_kNN5.1, 'Geboorteland')
kNN5.1_Onderwijsniveau <- plyr::count(S10df_kNN5.1, 'Onderwijsniveau')
kNN5.1_Econ_status <- plyr::count(S10df_kNN5.1, 'Econ._status')
kNN5.1_Beroep <- plyr::count(S10df_kNN5.1, 'Beroep')
kNN5.1_SBI <- plyr::count(S10df_kNN5.1, 'SBI')
kNN5.1_Burg_Staat <- plyr::count(S10df_kNN5.1, 'Burg._Staat')

kNN5.2_Geslacht <- plyr::count(S10df_kNN5.2, 'Geslacht')
kNN5.2_Leeftijd <- plyr::count(S10df_kNN5.2, 'Leeftijd')
kNN5.2_HH_Pos <- plyr::count(S10df_kNN5.2, 'HH_Pos')
kNN5.2_HH_grootte <- plyr::count(S10df_kNN5.2, 'HH_grootte')
kNN5.2_Woonregio_vorig_jaar <- plyr::count(S10df_kNN5.2, 'Woonregio_vorig_jaar')
kNN5.2_Nationaliteit <- plyr::count(S10df_kNN5.2, 'Nationaliteit')
kNN5.2_Geboorteland <- plyr::count(S10df_kNN5.2, 'Geboorteland')
kNN5.2_Onderwijsniveau <- plyr::count(S10df_kNN5.2, 'Onderwijsniveau')
kNN5.2_Econ_status <- plyr::count(S10df_kNN5.2, 'Econ._status')
kNN5.2_Beroep <- plyr::count(S10df_kNN5.2, 'Beroep')
kNN5.2_SBI <- plyr::count(S10df_kNN5.2, 'SBI')
kNN5.2_Burg_Staat <- plyr::count(S10df_kNN5.2, 'Burg._Staat')

kNN5.3_Geslacht <- plyr::count(S10df_kNN5.3, 'Geslacht')
kNN5.3_Leeftijd <- plyr::count(S10df_kNN5.3, 'Leeftijd')
kNN5.3_HH_Pos <- plyr::count(S10df_kNN5.3, 'HH_Pos')
kNN5.3_HH_grootte <- plyr::count(S10df_kNN5.3, 'HH_grootte')
kNN5.3_Woonregio_vorig_jaar <- plyr::count(S10df_kNN5.3, 'Woonregio_vorig_jaar')
kNN5.3_Nationaliteit <- plyr::count(S10df_kNN5.3, 'Nationaliteit')
kNN5.3_Geboorteland <- plyr::count(S10df_kNN5.3, 'Geboorteland')
kNN5.3_Onderwijsniveau <- plyr::count(S10df_kNN5.3, 'Onderwijsniveau')
kNN5.3_Econ_status <- plyr::count(S10df_kNN5.3, 'Econ._status')
kNN5.3_Beroep <- plyr::count(S10df_kNN5.3, 'Beroep')
kNN5.3_SBI <- plyr::count(S10df_kNN5.3, 'SBI')
kNN5.3_Burg_Staat <- plyr::count(S10df_kNN5.3, 'Burg._Staat')

rm(S10df_kNN5.1, S10df_kNN5.2, S10df_kNN5.3)
...
# Counting values
kNN10.1_Geslacht <- plyr::count(S10df_kNN10.1, 'Geslacht')
kNN10.1_Leeftijd <- plyr::count(S10df_kNN10.1, 'Leeftijd')
kNN10.1_HH_Pos <- plyr::count(S10df_kNN10.1, 'HH_Pos')
kNN10.1_HH_grootte <- plyr::count(S10df_kNN10.1, 'HH_grootte')
kNN10.1_Woonregio_vorig_jaar <- plyr::count(S10df_kNN10.1, 'Woonregio_vorig_jaar')
kNN10.1_Nationaliteit <- plyr::count(S10df_kNN10.1, 'Nationaliteit')
kNN10.1_Geboorteland <- plyr::count(S10df_kNN10.1, 'Geboorteland')
kNN10.1_Onderwijsniveau <- plyr::count(S10df_kNN10.1, 'Onderwijsniveau')
kNN10.1_Econ_status <- plyr::count(S10df_kNN10.1, 'Econ._status')
kNN10.1_Beroep <- plyr::count(S10df_kNN10.1, 'Beroep')
kNN10.1_SBI <- plyr::count(S10df_kNN10.1, 'SBI')
kNN10.1_Burg_Staat <- plyr::count(S10df_kNN10.1, 'Burg._Staat')

kNN10.2_Geslacht <- plyr::count(S10df_kNN10.2, 'Geslacht')
kNN10.2_Leeftijd <- plyr::count(S10df_kNN10.2, 'Leeftijd')
kNN10.2_HH_Pos <- plyr::count(S10df_kNN10.2, 'HH_Pos')
kNN10.2_HH_grootte <- plyr::count(S10df_kNN10.2, 'HH_grootte')
kNN10.2_Woonregio_vorig_jaar <- plyr::count(S10df_kNN10.2, 'Woonregio_vorig_jaar')
kNN10.2_Nationaliteit <- plyr::count(S10df_kNN10.2, 'Nationaliteit')
kNN10.2_Geboorteland <- plyr::count(S10df_kNN10.2, 'Geboorteland')
kNN10.2_Onderwijsniveau <- plyr::count(S10df_kNN10.2, 'Onderwijsniveau')
kNN10.2_Econ_status <- plyr::count(S10df_kNN10.2, 'Econ._status')
kNN10.2_Beroep <- plyr::count(S10df_kNN10.2, 'Beroep')
kNN10.2_SBI <- plyr::count(S10df_kNN10.2, 'SBI')
kNN10.2_Burg_Staat <- plyr::count(S10df_kNN10.2, 'Burg._Staat')

kNN10.3_Geslacht <- plyr::count(S10df_kNN10.3, 'Geslacht')
kNN10.3_Leeftijd <- plyr::count(S10df_kNN10.3, 'Leeftijd')
kNN10.3_HH_Pos <- plyr::count(S10df_kNN10.3, 'HH_Pos')
kNN10.3_HH_grootte <- plyr::count(S10df_kNN10.3, 'HH_grootte')
kNN10.3_Woonregio_vorig_jaar <- plyr::count(S10df_kNN10.3, 'Woonregio_vorig_jaar')
kNN10.3_Nationaliteit <- plyr::count(S10df_kNN10.3, 'Nationaliteit')
kNN10.3_Geboorteland <- plyr::count(S10df_kNN10.3, 'Geboorteland')
kNN10.3_Onderwijsniveau <- plyr::count(S10df_kNN10.3, 'Onderwijsniveau')
kNN10.3_Econ_status <- plyr::count(S10df_kNN10.3, 'Econ._status')
kNN10.3_Beroep <- plyr::count(S10df_kNN10.3, 'Beroep')
kNN10.3_SBI <- plyr::count(S10df_kNN10.3, 'SBI')
kNN10.3_Burg_Staat <- plyr::count(S10df_kNN10.3, 'Burg._Staat')

rm(S10df_kNN10.1, S10df_kNN10.2, S10df_kNN10.3)
