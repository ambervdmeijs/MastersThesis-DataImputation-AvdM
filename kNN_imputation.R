...
names(df_kNN2.1) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN2.2) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN2.3) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN5.1) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN5.2) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN5.3) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN10.1) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN10.2) <- gsub(" ", "_", names(ipums), fixed=TRUE)
names(df_kNN10.3) <- gsub(" ", "_", names(ipums), fixed=TRUE)
...
# Counting values
kNN2.1_Geslacht <- plyr::count(df_kNN2.1, 'Geslacht')
kNN2.1_Leeftijd <- plyr::count(df_kNN2.1, 'Leeftijd')
kNN2.1_HH_Pos <- plyr::count(df_kNN2.1, 'HH_Pos')
kNN2.1_HH_grootte <- plyr::count(df_kNN2.1, 'HH_grootte')
kNN2.1_Woonregio_vorig_jaar <- plyr::count(df_kNN2.1, 'Woonregio_vorig_jaar')
kNN2.1_Nationaliteit <- plyr::count(df_kNN2.1, 'Nationaliteit')
kNN2.1_Geboorteland <- plyr::count(df_kNN2.1, 'Geboorteland')
kNN2.1_Onderwijsniveau <- plyr::count(df_kNN2.1, 'Onderwijsniveau')
kNN2.1_Econ_status <- plyr::count(df_kNN2.1, 'Econ._status')
kNN2.1_Beroep <- plyr::count(df_kNN2.1, 'Beroep')
kNN2.1_SBI <- plyr::count(df_kNN2.1, 'SBI')
kNN2.1_Burg_Staat <- plyr::count(df_kNN2.1, 'Burg._Staat')

kNN2.2_Geslacht <- plyr::count(df_kNN2.2, 'Geslacht')
kNN2.2_Leeftijd <- plyr::count(df_kNN2.2, 'Leeftijd')
kNN2.2_HH_Pos <- plyr::count(df_kNN2.2, 'HH_Pos')
kNN2.2_HH_grootte <- plyr::count(df_kNN2.2, 'HH_grootte')
kNN2.2_Woonregio_vorig_jaar <- plyr::count(df_kNN2.2, 'Woonregio_vorig_jaar')
kNN2.2_Nationaliteit <- plyr::count(df_kNN2.2, 'Nationaliteit')
kNN2.2_Geboorteland <- plyr::count(df_kNN2.2, 'Geboorteland')
kNN2.2_Onderwijsniveau <- plyr::count(df_kNN2.2, 'Onderwijsniveau')
kNN2.2_Econ_status <- plyr::count(df_kNN2.2, 'Econ._status')
kNN2.2_Beroep <- plyr::count(df_kNN2.2, 'Beroep')
kNN2.2_SBI <- plyr::count(df_kNN2.2, 'SBI')
kNN2.2_Burg_Staat <- plyr::count(df_kNN2.2, 'Burg._Staat')

kNN2.3_Geslacht <- plyr::count(df_kNN2.3, 'Geslacht')
kNN2.3_Leeftijd <- plyr::count(df_kNN2.3, 'Leeftijd')
kNN2.3_HH_Pos <- plyr::count(df_kNN2.3, 'HH_Pos')
kNN2.3_HH_grootte <- plyr::count(df_kNN2.3, 'HH_grootte')
kNN2.3_Woonregio_vorig_jaar <- plyr::count(df_kNN2.3, 'Woonregio_vorig_jaar')
kNN2.3_Nationaliteit <- plyr::count(df_kNN2.3, 'Nationaliteit')
kNN2.3_Geboorteland <- plyr::count(df_kNN2.3, 'Geboorteland')
kNN2.3_Onderwijsniveau <- plyr::count(df_kNN2.3, 'Onderwijsniveau')
kNN2.3_Econ_status <- plyr::count(df_kNN2.3, 'Econ._status')
kNN2.3_Beroep <- plyr::count(df_kNN2.3, 'Beroep')
kNN2.3_SBI <- plyr::count(df_kNN2.3, 'SBI')
kNN2.3_Burg_Staat <- plyr::count(df_kNN2.3, 'Burg._Staat')

rm(df_kNN2.1, df_kNN2.2, df_kNN2.3)
...
# Counting values
kNN5.1_Geslacht <- plyr::count(df_kNN5.1, 'Geslacht')
kNN5.1_Leeftijd <- plyr::count(df_kNN5.1, 'Leeftijd')
kNN5.1_HH_Pos <- plyr::count(df_kNN5.1, 'HH_Pos')
kNN5.1_HH_grootte <- plyr::count(df_kNN5.1, 'HH_grootte')
kNN5.1_Woonregio_vorig_jaar <- plyr::count(df_kNN5.1, 'Woonregio_vorig_jaar')
kNN5.1_Nationaliteit <- plyr::count(df_kNN5.1, 'Nationaliteit')
kNN5.1_Geboorteland <- plyr::count(df_kNN5.1, 'Geboorteland')
kNN5.1_Onderwijsniveau <- plyr::count(df_kNN5.1, 'Onderwijsniveau')
kNN5.1_Econ_status <- plyr::count(df_kNN5.1, 'Econ._status')
kNN5.1_Beroep <- plyr::count(df_kNN5.1, 'Beroep')
kNN5.1_SBI <- plyr::count(df_kNN5.1, 'SBI')
kNN5.1_Burg_Staat <- plyr::count(df_kNN5.1, 'Burg._Staat')

kNN5.2_Geslacht <- plyr::count(df_kNN5.2, 'Geslacht')
kNN5.2_Leeftijd <- plyr::count(df_kNN5.2, 'Leeftijd')
kNN5.2_HH_Pos <- plyr::count(df_kNN5.2, 'HH_Pos')
kNN5.2_HH_grootte <- plyr::count(df_kNN5.2, 'HH_grootte')
kNN5.2_Woonregio_vorig_jaar <- plyr::count(df_kNN5.2, 'Woonregio_vorig_jaar')
kNN5.2_Nationaliteit <- plyr::count(df_kNN5.2, 'Nationaliteit')
kNN5.2_Geboorteland <- plyr::count(df_kNN5.2, 'Geboorteland')
kNN5.2_Onderwijsniveau <- plyr::count(df_kNN5.2, 'Onderwijsniveau')
kNN5.2_Econ_status <- plyr::count(df_kNN5.2, 'Econ._status')
kNN5.2_Beroep <- plyr::count(df_kNN5.2, 'Beroep')
kNN5.2_SBI <- plyr::count(df_kNN5.2, 'SBI')
kNN5.2_Burg_Staat <- plyr::count(df_kNN5.2, 'Burg._Staat')

kNN5.3_Geslacht <- plyr::count(df_kNN5.3, 'Geslacht')
kNN5.3_Leeftijd <- plyr::count(df_kNN5.3, 'Leeftijd')
kNN5.3_HH_Pos <- plyr::count(df_kNN5.3, 'HH_Pos')
kNN5.3_HH_grootte <- plyr::count(df_kNN5.3, 'HH_grootte')
kNN5.3_Woonregio_vorig_jaar <- plyr::count(df_kNN5.3, 'Woonregio_vorig_jaar')
kNN5.3_Nationaliteit <- plyr::count(df_kNN5.3, 'Nationaliteit')
kNN5.3_Geboorteland <- plyr::count(df_kNN5.3, 'Geboorteland')
kNN5.3_Onderwijsniveau <- plyr::count(df_kNN5.3, 'Onderwijsniveau')
kNN5.3_Econ_status <- plyr::count(df_kNN5.3, 'Econ._status')
kNN5.3_Beroep <- plyr::count(df_kNN5.3, 'Beroep')
kNN5.3_SBI <- plyr::count(df_kNN5.3, 'SBI')
kNN5.3_Burg_Staat <- plyr::count(df_kNN5.3, 'Burg._Staat')

rm(df_kNN5.1, df_kNN5.2, df_kNN5.3)
...
# Counting values
kNN10.1_Geslacht <- plyr::count(df_kNN10.1, 'Geslacht')
kNN10.1_Leeftijd <- plyr::count(df_kNN10.1, 'Leeftijd')
kNN10.1_HH_Pos <- plyr::count(df_kNN10.1, 'HH_Pos')
kNN10.1_HH_grootte <- plyr::count(df_kNN10.1, 'HH_grootte')
kNN10.1_Woonregio_vorig_jaar <- plyr::count(df_kNN10.1, 'Woonregio_vorig_jaar')
kNN10.1_Nationaliteit <- plyr::count(df_kNN10.1, 'Nationaliteit')
kNN10.1_Geboorteland <- plyr::count(df_kNN10.1, 'Geboorteland')
kNN10.1_Onderwijsniveau <- plyr::count(df_kNN10.1, 'Onderwijsniveau')
kNN10.1_Econ_status <- plyr::count(df_kNN10.1, 'Econ._status')
kNN10.1_Beroep <- plyr::count(df_kNN10.1, 'Beroep')
kNN10.1_SBI <- plyr::count(df_kNN10.1, 'SBI')
kNN10.1_Burg_Staat <- plyr::count(df_kNN10.1, 'Burg._Staat')

kNN10.2_Geslacht <- plyr::count(df_kNN10.2, 'Geslacht')
kNN10.2_Leeftijd <- plyr::count(df_kNN10.2, 'Leeftijd')
kNN10.2_HH_Pos <- plyr::count(df_kNN10.2, 'HH_Pos')
kNN10.2_HH_grootte <- plyr::count(df_kNN10.2, 'HH_grootte')
kNN10.2_Woonregio_vorig_jaar <- plyr::count(df_kNN10.2, 'Woonregio_vorig_jaar')
kNN10.2_Nationaliteit <- plyr::count(df_kNN10.2, 'Nationaliteit')
kNN10.2_Geboorteland <- plyr::count(df_kNN10.2, 'Geboorteland')
kNN10.2_Onderwijsniveau <- plyr::count(df_kNN10.2, 'Onderwijsniveau')
kNN10.2_Econ_status <- plyr::count(df_kNN10.2, 'Econ._status')
kNN10.2_Beroep <- plyr::count(df_kNN10.2, 'Beroep')
kNN10.2_SBI <- plyr::count(df_kNN10.2, 'SBI')
kNN10.2_Burg_Staat <- plyr::count(df_kNN10.2, 'Burg._Staat')

kNN10.3_Geslacht <- plyr::count(df_kNN10.3, 'Geslacht')
kNN10.3_Leeftijd <- plyr::count(df_kNN10.3, 'Leeftijd')
kNN10.3_HH_Pos <- plyr::count(df_kNN10.3, 'HH_Pos')
kNN10.3_HH_grootte <- plyr::count(df_kNN10.3, 'HH_grootte')
kNN10.3_Woonregio_vorig_jaar <- plyr::count(df_kNN10.3, 'Woonregio_vorig_jaar')
kNN10.3_Nationaliteit <- plyr::count(df_kNN10.3, 'Nationaliteit')
kNN10.3_Geboorteland <- plyr::count(df_kNN10.3, 'Geboorteland')
kNN10.3_Onderwijsniveau <- plyr::count(df_kNN10.3, 'Onderwijsniveau')
kNN10.3_Econ_status <- plyr::count(df_kNN10.3, 'Econ._status')
kNN10.3_Beroep <- plyr::count(df_kNN10.3, 'Beroep')
kNN10.3_SBI <- plyr::count(df_kNN10.3, 'SBI')
kNN10.3_Burg_Staat <- plyr::count(df_kNN10.3, 'Burg._Staat')

rm(df_kNN10.1, df_kNN10.2, df_kNN10.3)
